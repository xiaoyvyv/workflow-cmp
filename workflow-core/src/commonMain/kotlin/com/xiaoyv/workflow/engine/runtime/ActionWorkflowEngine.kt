package com.xiaoyv.workflow.engine.runtime
...
import com.xiaoyv.workflow.exception.ActionErrorCode
import com.xiaoyv.workflow.exception.ActionNodeExecutionException
import com.xiaoyv.workflow.exception.ActionWorkflowException
import com.xiaoyv.workflow.exception.ActionWorkflowTraceLogger
...
import com.xiaoyv.workflow.model.log.ActionExecutionStep
...
import com.xiaoyv.workflow.model.spec.ActionLoopContextKey
...
class ActionWorkflowEngine(
    ...
    private fun resolveLoopTransition(
        workflow: ActionWorkflow,
        node: com.xiaoyv.workflow.model.definition.ActionNode,
