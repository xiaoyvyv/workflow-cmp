...
import com.xiaoyv.workflow.node.builtin.branchesPort
import com.xiaoyv.workflow.node.builtin.catchPort
import com.xiaoyv.workflow.node.builtin.defaultPort
import com.xiaoyv.workflow.node.builtin.failurePort
import com.xiaoyv.workflow.node.builtin.finallyPort
import com.xiaoyv.workflow.node.builtin.inPort
import com.xiaoyv.workflow.node.builtin.matchedPort
import com.xiaoyv.workflow.node.builtin.nextPort
import com.xiaoyv.workflow.node.builtin.tryPort
 ...
 * 控制工作流入口和终点的内置节点。
 */
fun flowActionNodeDefinitions(logger: ActionWorkflowLogger): List<ActionNodeDefinition> = listOf(
    startDefinition(),
