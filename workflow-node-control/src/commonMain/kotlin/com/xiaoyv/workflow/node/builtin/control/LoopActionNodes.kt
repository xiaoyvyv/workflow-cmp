...
import com.xiaoyv.workflow.node.builtin.bodyPort
import com.xiaoyv.workflow.node.builtin.completedPort
import com.xiaoyv.workflow.node.builtin.failurePort
import com.xiaoyv.workflow.node.builtin.inPort
import com.xiaoyv.workflow.node.builtin.loopControlInPort
 ...
 */
val loopActionNodeDefinitions: List<ActionNodeDefinition> = listOf(
