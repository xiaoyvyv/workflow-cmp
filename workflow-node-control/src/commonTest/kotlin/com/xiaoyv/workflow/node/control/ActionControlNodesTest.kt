package com.xiaoyv.workflow.node.control
...
import com.xiaoyv.workflow.node.fixture.ActionNodeTestFixtures
import com.xiaoyv.workflow.node.fixture.ActionNodeTestFixtures.config
import com.xiaoyv.workflow.node.fixture.ActionNodeTestFixtures.testHttpRequestExecutor
import com.xiaoyv.workflow.node.fixture.ActionNodeTestFixtures.testPreferencesStore
...
class ActionControlNodesTest {
    ...
    fun testBranchingAndJoiningWorkflow() = runBlocking {
        ...
        val registry = ActionNodeRegistry(builtInActionNodeDefinitions(testHttpRequestExecutor, testPreferencesStore))
