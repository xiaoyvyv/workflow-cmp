package com.xiaoyv.workflow.node.data
...
class ActionDataNodesTest {
    ...
    fun testActionJsonPathInvalidPrefixThrowsException() {
        val ex = assertFailsWith<IllegalArgumentException> {
            com.xiaoyv.workflow.node.resolver.ActionJsonPath.resolve(buildJsonObject { }, "invalid_path_without_dollar")
        }
    ...
    fun testActionUrlPolicyNonHttpUrlThrowsException() {
        val ex = assertFailsWith<IllegalArgumentException> {
            com.xiaoyv.workflow.node.resolver.ActionUrlPolicy.requireHttpUrl("ftp://example.com/file")
        }
