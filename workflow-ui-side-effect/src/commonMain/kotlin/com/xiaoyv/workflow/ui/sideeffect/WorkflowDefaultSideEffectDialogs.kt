...
import com.xiaoyv.workflow.ui.WorkflowSideEffectData
            ...
            Column(
                ...
                tasks.forEach { task ->
                    ...
                    LinearProgressIndicator(
                        progress = {
                            if (task.effect.mode == ActionProgressDialogMode.DETERMINATE) {
                                ((task.effect.progress ?: 0f) / (task.effect.maxProgress ?: 1f)).coerceIn(0f, 1f)
                            } else {
                                0f
                            }
                        },
